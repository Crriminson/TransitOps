...
-- CreateEnum
CREATE TYPE "VehicleType" AS ENUM ('TRUCK', 'VAN', 'MINI_TRUCK', 'TRAILER', 'BIKE');
...
-- CreateEnum
CREATE TYPE "TripStatus" AS ENUM ('DRAFT', 'DISPATCHED', 'HALTED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "MaintenanceLogStatus" AS ENUM ('OPEN', 'CLOSED');
...
CREATE TABLE "Vehicle" (
    ...
    "maxLoadCapacity" DECIMAL(65,30) NOT NULL,
    "odometer" DECIMAL(65,30) NOT NULL,
    "acquisitionCost" DECIMAL(65,30) NOT NULL,
    "status" "VehicleStatus" NOT NULL DEFAULT 'AVAILABLE',
    "region" "Region" NOT NULL,
    "lastServiceOdometer" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Route" (
    ...
    "sourceLat" DECIMAL(65,30),
    "sourceLng" DECIMAL(65,30),
    "destinationLat" DECIMAL(65,30),
    "destinationLng" DECIMAL(65,30),
    "standardDistance" DECIMAL(65,30) NOT NULL,
